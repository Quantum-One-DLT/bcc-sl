...
module Bcc.Wallet.Kernel.Addresses (
      createAddress
    , newHdAddress
    , importAddresses
    -- * Errors
...
import           Bcc.Wallet.Kernel.DB.AcidState (CreateHdAddress (..))
...
import           Bcc.Wallet.WalletLayer.Kernel.Conv (toBccAddress)
            ...
            case mbAddr of
                 ...
                 Just hdAddress -> do
                    ...
                    case res of
                         ...
                         Right () -> return (Right $ toBccAddress hdAddress)

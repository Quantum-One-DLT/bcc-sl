...
lrcDo genesisConfig epoch consumers = do
    ...
    case era of
        ...
        SBFT _ -> do
            -- During SBFT, we don't need to perform any SSC operations such as
            ...
            -- follow a strict round-robin schedule for SBFT.
            --
            ...
            -- stakeholders (which are utilized for the SBFT schedule) to
            -- diverge.
            withBlocksRolledBack blundsToRollbackNE $ do
                issuersAndRichmenComputationDo
                DB.sanityCheckDB $ configGenesisData genesisConfig

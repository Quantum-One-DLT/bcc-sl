...
recordTxpMetrics ekgStore memPoolVar = do
    ekgMemPoolSize <-
        Metrics.createGauge (withBccNamespace "MemPoolSize") ekgStore
    ekgMemPoolWaitTimeApplyBlock <-
        Metrics.createGauge (withBccNamespace "MemPoolWaitTimeApplyBlock_microseconds") ekgStore
    ekgMemPoolModifyTimeApplyBlock <-
        Metrics.createGauge (withBccNamespace "MemPoolModifyTimeApplyBlock_microseconds") ekgStore
    ekgMemPoolWaitTimeApplyBlockWithRollback <-
        Metrics.createGauge (withBccNamespace "MemPoolWaitTimeApplyBlockWithRollback_microseconds") ekgStore
    ekgMemPoolModifyTimeApplyBlockWithRollback <-
        Metrics.createGauge (withBccNamespace "MemPoolModifyTimeApplyBlockWithRollback_microseconds") ekgStore
    ekgMemPoolWaitTimeProcessTx <-
        Metrics.createGauge (withBccNamespace "MemPoolWaitTimeProcessTx_microseconds") ekgStore
    ekgMemPoolModifyTimeProcessTx <-
        Metrics.createGauge (withBccNamespace "MemPoolModifyTimeProcessTx_microseconds") ekgStore
    ekgMemPoolQueueLength <-
        Metrics.createGauge (withBccNamespace "MemPoolQueueLength") ekgStore

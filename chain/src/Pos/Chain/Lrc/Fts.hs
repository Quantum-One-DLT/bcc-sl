...
-- The currency of the Bcc network is called "Bcc" and its smallest
-- indivisible unit is called the "Entropic".
...
-- amount of Entropic (the smallest indivisible unit of the Bcc currency) in

...
translation =
    ...
    , footer:
        ...
        , fooEmail: "Email"
        , fooTwitter: "Twitter"
        , fooKlarityPlatform: "ダイダロスプラットフォーム"
        , fooWhyBcc: "なぜカルダノなのか"
        , fooBccRoadmap: "カルダノロードマップ"
        , fooBccSource: "カルダノSLソース"
        , fooBccFoundation: "カルダノ財団"
        , fooBccFoundationYoutube: "カルダノ財団 Youtube"
        , fooBccFoundationTwitter: "カルダノ財団 Twitter"
        , fooBccHub: "カルダノハブ"
        , fooBccChat: "チャット"
        , fooBccForum: "フォーラム"
        , fooBccReddit: "カルダノ財団 Reddit"
        , fooBccCommunity: "カルダノコミュニティー"
        , fooBccDocumentation: "カルダノドキュメンテーション"
        , fooBccTestnet: "カルダノテストネット"
        , fooBccOpenSource: "カルダノはオープンソースプロジェクトです"
        , fooTBCO: "TBCO"
        , fooTBCOBlog: "TBCOブログ"
        , fooTBCOYoutube: "TBCO YouTube"
        , fooDisclaimerPt1: "Bccはソフトウェアプラットフォームのみを提供します。いかなるブロックチェーン、デジタル通貨、暗号通貨または関連技術についても、独立したデューディリジェンスや実質的なレビューを行うことはありません。本ウェブサイトおよびソフトウェアの使用は完全にユーザー自身の責任で行われるものとし、本ウェブサイトは現状有り姿ベースで参照の便宜を目的としてのみ提供されます。"
        , fooDisclaimerPt2: ""
        , fooProject: "プロジェクト"
        , fooProtocol: "プロトコル"
        , fooFoundation: "財団"

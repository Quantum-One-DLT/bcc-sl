...
import Explorer.I18n.Lenses (cBCC, dbTotalAmountOfTransactions, cTransactions, dbTotalAmountOf, dbTotalSupply, dbPriceSince, dbPriceForOne, dbPriceAverage, cNetwork, common, dashboard, dbLastBlocks, dbLastBlocksDescription) as I18nL
...
networkItems lang =
    let bcc = translate (I18nL.common <<< I18nL.cBCC) lang in
    ...
    , { headline: translate (I18nL.dashboard <<< I18nL.dbPriceAverage) lang
      , subheadline: flip substitute ["1,000,000$", bcc]
    ...
    , { headline: translate (I18nL.dashboard <<< I18nL.dbTotalSupply) lang
      , subheadline: flip substitute ["9,876,543,210 "] $ translate (I18nL.common <<< I18nL.cBCC) lang
      , description: flip substitute [bcc] $ translate (I18nL.dashboard <<< I18nL.dbTotalAmountOf) lang
      }

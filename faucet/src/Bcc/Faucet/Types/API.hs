...
import           Bcc.Wallet.API.V1.Types (Transaction, V1 (..))
...
--------------------------------------------------------------------------------
-- | A request to withdraw BCC from the faucet wallet
data WithdrawalRequest = WithdrawalRequest {
    -- | The address to send the BCC to

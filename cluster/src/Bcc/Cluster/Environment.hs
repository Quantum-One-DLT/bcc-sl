...
module Bcc.Cluster.Environment
    (
    -- * Environment
      Env
    , Artifact(..)
...
import           Bcc.Cluster.Util (getsModify, indexedForM_, nextNtwrkAddr,
                     ...
                     (|>))
import           Bcc.Node.Manager (Manager, mkHttpsManagerSettings,
                     newManager)
...
withStateDirectory mdir cb =
    case mdir of
        Nothing ->
            withSystemTempDirectory "bcc-sl-cluster" cb
